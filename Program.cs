...
foreach (string name in studentNames)
{
    ...
    int extraCreditsScores = 0;
    int numberOfExtraGrades = studentScores.Length - examAssignments;
    /* 
    ...
    */
    foreach (int score in studentScores)
    {
        ...
        if (gradedAssignments > 5) {
            extraCreditsScores += score;
        }
    }
    
    decimal extraCredits = (decimal) extraCreditsScores / numberOfExtraGrades;
    currentStudentGrade = (decimal) sumAssignmentScores / examAssignments;
    examScores = examScores / examAssignments;
    decimal extraCreditPoints = extraCredits/10/examAssignments*numberOfExtraGrades;
